...
use Nim\Bundle\WorkerBundle\Model\Passport;
use Nim\Bundle\WorkerBundle\Model\Phone;
use Nim\Bundle\WorkerBundle\Model\Visa;
...
class WorkerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Nim\Bundle\WorkerBundle\Model\Worker');
    }

    public function it_should_implement_worker_interface()
    {
        $this->shouldImplement('Nim\Bundle\WorkerBundle\Model\WorkerInterface');
    }
